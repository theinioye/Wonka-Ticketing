...
export class Migrations1741179380291 implements MigrationInterface {
    name = 'Migrations1741179380291'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "planner" ADD "lastLogInDate" TIMESTAMP`);
